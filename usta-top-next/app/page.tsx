    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-4xl mx-auto text-center mt-10 mb-16">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6">
          Sizga zudlik bilan <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">usta kerak</span>mi?
        </h1>
        <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
          Uyingizdagi muammolarni tez va sifatli hal qilish uchun mutaxassis qidiryapsizmi? Bizning platformamiz orqali malakali <strong className="text-gray-800">santexnik</strong>, tajribali <strong className="text-gray-800">elektrik</strong> va boshqa turdagi yuzlab ustalarni bir necha daqiqada topishingiz mumkin. Eng yaxshi xizmatlar kafolatlangan oson <strong className="text-gray-800">usta topish</strong> imkoniyatidan foydalaning!
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link 
            href="/royxat" 
            className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1"
          >
            Usta topish
          </Link>
          <a 
            href="#ustalar" 
            className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-gray-50 text-blue-600 font-semibold rounded-xl shadow border border-gray-200 transition duration-300 ease-in-out"
          >
            Barcha xizmatlar
          </a>
        </div>
